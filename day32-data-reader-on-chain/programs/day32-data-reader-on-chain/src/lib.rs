...
declare_id!("BPKoBKsydAZNBBfjHsg63yJgWg7genNCwQ9jbtbNzMhH");

#[program]
pub mod day32_data_reader_on_chain {
    use super::*;
    ...
    pub fn read_other_data(ctx: Context<ReadOtherData>) -> Result<()> {
        ...
        // data_slice is the raw bytes of the data in the account
        let mut data_slice: &[u8] = &data_account.data.borrow();

        // deserialize the data into our Storage struct
